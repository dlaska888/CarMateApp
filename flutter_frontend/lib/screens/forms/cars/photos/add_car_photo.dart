...
class AddCarPhotoForm extends StatefulWidget {
  final Car car;
  final Function onSubmit;
  const AddCarPhotoForm(this.car, this.onSubmit, {super.key});

  @override
  State<AddCarPhotoForm> createState() => _AddCarPhotoFormState();
}

class _AddCarPhotoFormState extends State<AddCarPhotoForm> {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      ApiClient.postPhoto(
              '${ApiEndpoints.carsEndpoint}/${widget.car.id}/photos', file!)
          .then((_) {
        widget.onSubmit();
