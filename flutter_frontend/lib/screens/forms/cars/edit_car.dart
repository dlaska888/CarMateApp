...
class EditCarFormState extends State<EditCarForm> {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      ApiClient.sendRequest('${ApiEndpoints.carsEndpoint}/${_car.id}',
              methodFun: http.put, body: _car.toJson(), authorizedRequest: true)
          .then((_) {
        widget.onSubmit();
  ...
  void initState() {
    ...
    productionDateController = TextEditingController(
        text: _car.productionDate?.toString().split(" ")[0]);
    purchaseDateController = TextEditingController(
        text: _car.purchaseDate?.toString().split(" ")[0]);
  }
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      onSaved: (value) {
                        setState(() {
                          _car.name = value!.isNotEmpty ? value : _car.name;
                        });
                      },
                    ),
                    const SizedBox(),
                    TextFormField(
                      ...
                      onSaved: (value) {
                        setState(() {
                          _car.brand = value!.isNotEmpty ? value : null;
                        });
                      },
                    ),
                    TextFormField(
                      ...
                      onSaved: (value) {
                        setState(() {
                          _car.model = value!.isNotEmpty ? value : null;
                        });
                      },
                    ),
                    TextFormField(
                    ...
                    TextFormField(
                      ...
                      onSaved: (value) {
                        setState(() {
                          _car.vin = value!.isNotEmpty ? value : null;
                        });
                      },
                    ),
                    const SizedBox(),
                    ...
                    TextFormField(
                      initialValue: _car.mileage?.toString(),
                      decoration: const InputDecoration(
                        labelText: 'Mileage',
                      ),
                    ...
                    TextFormField(
                      ...
                      onSaved: (value) {
                        setState(() {
                          _car.plate = value!.isNotEmpty ? value : null;
                        });
                      },
                    ),
                    ConstrainedBox(
