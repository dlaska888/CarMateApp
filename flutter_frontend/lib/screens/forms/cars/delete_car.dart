...
class DeleteCarForm extends StatefulWidget {
  final Car car;
  final Function onSubmit;
  const DeleteCarForm(this.car, this.onSubmit, {super.key});

  @override
  DeleteCarFormState createState() => DeleteCarFormState();
}

class DeleteCarFormState extends State<DeleteCarForm> {
